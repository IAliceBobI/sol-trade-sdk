...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let trade_fee_rate = amm_info.fees.trade_fee_numerator as f64
        / amm_info.fees.trade_fee_denominator as f64
        * 100.0;
    let swap_fee_rate =
        amm_info.fees.swap_fee_numerator as f64 / amm_info.fees.swap_fee_denominator as f64 * 100.0;

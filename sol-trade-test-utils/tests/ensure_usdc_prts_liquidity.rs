//! 测试 ensure_usdc_prts_pool_usdc_liquidity 函数
//!
//! 这个测试会：
...
#[tokio::test]
#[serial_test::serial]
async fn test_ensure_usdc_prts_pool_usdc_liquidity() {
    println!("\n========================================");
    println!("测试: 确保 USDC-PRTS Pool 流动性");
    println!("========================================\n");
    ...
    match ensure_usdc_prts_pool_usdc_liquidity(&rpc, &rpc_url, &payer, 1000).await {
        Ok(_) => {
            println!("\n✅ 流动性确保成功！\n");
        },
        Err(e) => {
